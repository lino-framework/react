...
class Menu(View):
    def get(self, request):
        """Getting the menu rendered via JSON data"""
        ar = BaseRequest(
            # user=user,
            request=request,
        ...
        # json_string = `"[{\"menu\":{\"items\":[{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Shows all persons.\\\")\"},\"text\":\"Persons\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"An organisation.  The verbose name is because the latter easier to type and\\\\nfor historical reasons.\\\")\"},\"text\":\"Organizations\"},{\"text\":\"Partner Lists\"}]},\"text\":\"Contacts\"},{\"menu\":{\"items\":[{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Table of appointments for which I am responsible.\\\")\"},\"text\":\"My appointments\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Shows overdue appointments, i.e. appointments whose date is\\\\nover but who are still in a nonstable state.\\\")\"},\"text\":\"Overdue appointments\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Shows my appointments in the near future which are in suggested or\\\\ndraft state.\\\")\"},\"text\":\"Unconfirmed appointments\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Shows my tasks whose start date is today or in the future.\\\")\"},\"text\":\"My tasks\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"The default table of presences.\\\")\"},\"text\":\"My guests\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Shows all my presences in calendar events, independently of their\\\\nstate.\\\")\"},\"text\":\"My presences\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Like OverdueAppointments, but only for myself.\\\")\"},\"text\":\"My overdue appointments\"},{\"iconCls\":\"x-tbar-calendar\",\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Displays your events in a      with the possibility to switch between daily, weekly, monthly view.\\\")\"},\"text\":\"Calendar\"}]},\"text\":\"Calendar\"},{\"menu\":{\"items\":[{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Base class for all tables on Excerpt.\\\")\"},\"text\":\"My Excerpts\"},{\"text\":\"My Comments\"},{\"text\":\"Recent comments\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Shows messages emitted to me.\\\")\"},\"text\":\"My Notification messages\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Shows only my Uploads (i.e. those whose author is current user).\\\")\"},\"text\":\"My Uploads\"}]},\"text\":\"Office\"},{\"menu\":{\"items\":[{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Show all active tickets reported by me.\\\")\"},\"text\":\"My tickets\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Show all tickets that are in an active state.\\\")\"},\"text\":\"Active tickets\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Shows all tickets.\\\")\"},\"text\":\"All tickets\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Base class for all tables of tickets.\\\")\"},\"text\":\"Unassigned Tickets\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Shows all tickets that have a reference.\\\")\"},\"text\":\"Reference Tickets\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Shows the sites for which I have a subscription.\\\")\"},\"text\":\"My sites\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Show all active tickets assigned to me.\\\")\"},\"text\":\"Tickets to work\"}]},\"text\":\"Tickets\"},{\"menu\":{\"items\":[{\"text\":\"Sessions\"},{\"text\":\"Service Reports\"},{\"text\":\"Worked hours\"}]},\"text\":\"Working time\"},{\"menu\":{\"items\":[{\"text\":\"My Commits\"}]},\"text\":\"GitHub\"},{\"menu\":{\"items\":[{\"text\":\"Messages\"}]},\"text\":\"Mailbox\"},{\"menu\":{\"items\":[{\"menu\":{\"items\":[{\"iconCls\":\"x-tbar-application_form\",\"text\":\"Site Parameters\"},{\"text\":\"Help Texts\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Shows the list of all users on this site.\\\")\"},\"text\":\"Users\"}]},\"text\":\"System\"},{\"menu\":{\"items\":[{\"text\":\"Countries\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"\\\\n    The table of known geographical places.\\\\n    A geographical place can be a city, a town, a suburb,\\\\n    a province, a lake... any named geographic entity,\\\\n    except for countries because these have their own table.\\\\n    \\\")\"},\"text\":\"Places\"}]},\"text\":\"Places\"},{\"menu\":{\"items\":[{\"text\":\"Organization types\"},{\"text\":\"Functions\"},{\"text\":\"List Types\"}]},\"text\":\"Contacts\"},{\"menu\":{\"items\":[{\"text\":\"Calendars\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"List of rooms where calendar events can happen.\\\")\"},\"text\":\"Rooms\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"List of possible priorities of calendar events.\\\")\"},\"text\":\"Priorities\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"The list of all recurrent events (RecurrentEvent).\\\")\"},\"text\":\"Recurring events\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Global table of guest roles.\\\")\"},\"text\":\"Guest roles\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"The list of entry types defined on this site.\\\")\"},\"text\":\"Calendar entry types\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Global table of all possible recurrencly policies.\\\")\"},\"text\":\"Recurrency policies\"},{\"text\":\"Remote Calendars\"},{\"text\":\"Planner rows\"}]},\"text\":\"Calendar\"},{\"menu\":{\"items\":[{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Displays all rows of ExcerptType.\\\")\"},\"text\":\"Excerpt Types\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"The table with all existing comment types.\\\")\"},\"text\":\"Comment Types\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"The table with all existing upload types.\\\")\"},\"text\":\"Upload Types\"},{\"text\":\"My Text Field Templates\"}]},\"text\":\"Office\"},{\"menu\":{\"items\":[{\"text\":\"Ticket types\"},{\"text\":\"Sites\"}]},\"text\":\"Tickets\"},{\"menu\":{\"items\":[{\"text\":\"Session Types\"}]},\"text\":\"Working time\"},{\"menu\":{\"items\":[{\"text\":\"Repositories\"}]},\"text\":\"GitHub\"},{\"menu\":{\"items\":[{\"text\":\"Mailboxes\"}]},\"text\":\"Mailbox\"}]},\"text\":\"Configure\"},{\"menu\":{\"items\":[{\"menu\":{\"items\":[{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Default table for django.contrib.ContentType.\\\")\"},\"text\":\"content types\"},{\"text\":\"Authorities\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"The list of user types available in this application.\\\")\"},\"text\":\"User types\"},{\"text\":\"User roles\"},{\"text\":\"Third-party authorizations\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"The default table for Change.\\\")\"},\"text\":\"Changes\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"The gobal list of all messages.\\\")\"},\"text\":\"Notification messages\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"The list of data problem types known by this application.\\\")\"},\"text\":\"Data checkers\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Show all data problems.\\\")\"},\"text\":\"Data problems\"},{\"text\":\"All dashboard widgets\"},{\"text\":\"User Statistics\"}]},\"text\":\"System\"},{\"menu\":{\"items\":[{\"text\":\"Contact Persons\"},{\"text\":\"Partners\"},{\"text\":\"List memberships\"}]},\"text\":\"Contacts\"},{\"menu\":{\"items\":[{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Table which shows all calendar events.\\\")\"},\"text\":\"events\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Global table of all tasks for all users.\\\")\"},\"text\":\"Tasks\"},{\"text\":\"Subscriptions\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"The possible states of a calendar entry.\\\\nStored in the state field.\\\")\"},\"text\":\"Event states\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Global choicelist of possible guest states.\\\")\"},\"text\":\"Guest states\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Possible values for the state of a Task. The list of\\\\nchoices for the Task.state field.\\\")\"},\"text\":\"Task states\"}]},\"text\":\"Calendar\"},{\"menu\":{\"items\":[{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Base class for all tables on Excerpt.\\\")\"},\"text\":\"Excerpts\"},{\"text\":\"Comments\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Shows all Uploads\\\")\"},\"text\":\"Uploads\"},{\"text\":\"Upload Areas\"},{\"text\":\"Text Field Templates\"}]},\"text\":\"Office\"},{\"menu\":{\"items\":[{\"text\":\"Dependencies\"},{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"The choicelist of possible values for the state of a ticket.\\\")\"},\"text\":\"Ticket states\"},{\"text\":\"Site subscriptions\"}]},\"text\":\"Tickets\"},{\"menu\":{\"items\":[{\"text\":\"Sessions\"},{\"text\":\"Site summaries\"}]},\"text\":\"Working time\"},{\"menu\":{\"items\":[{\"text\":\"Commits\"}]},\"text\":\"GitHub\"},{\"menu\":{\"items\":[{\"text\":\"Messages\"}]},\"text\":\"Mailbox\"}]},\"text\":\"Explorer\"},{\"menu\":{\"items\":[{\"listeners\":{\"render\":\"quicktip_renderer(\\\"Foo\\\",\\\"Show information about this site.\\\")\"},\"text\":\"About\"}]},\"text\":\"Site\"}]"`
