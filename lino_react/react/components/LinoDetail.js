    ...
    render() {
        return (
            <React.Fragment>
                ...
                {!this.props.noToolbar && this.state.show_top_toolbar && <Toolbar
                    ...
                    left={<React.Fragment>
                        ...
                        <ToggleButton
                            ...
                            tooltip={this.state.editing_mode ? "Cancel" : "Edit"}/>}
